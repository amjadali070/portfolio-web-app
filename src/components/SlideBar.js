  ...
  return (
    <div className="flex-none hidden lg:block  bg-black h-screen min-w-[25%] fixed ">
      <div className="nav flex  text-white text-lg mt-10 flex-col align-middle justify-center text-center w-full gap-5 overflow-hidden">
        ...
        <p
          onClick={() => setSelect(1)}
          className={`-pointer hover:text-blue-600 hover:-translate-y-0.5 hover:text-xl transition hover:transition ${
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/amjadali070", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://instagram.com/amjadali070?igshid=M2RkZGJiMzhjOQ==", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/amjadali070",
              "_blank"
            )
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.facebook.com/amjadali070", "_blank")
          }
        >
