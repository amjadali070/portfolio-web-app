      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3
            ...
            data-aos={"fade-left"}
          >
            I'm <span className="text-yellow-600">Amjad Ali,</span> a Web
            Enthusiast
          </h3>
          <p
          ...
          >
            ...
            Passionate full stack developer with expertise in both front-end and back-end development. 
            Proven track record in creating scalable applications and successful Android apps downloaded 
            by thousands. Adaptable to new technologies, committed to continuous learning, and dedicated 
            to staying current with industry trends. Eager to tackle new challenges, contribute 
            collaboratively, and bring value to projects. Open to connecting for potential opportunities.
          </p>
          <p
            className="text-justify leading-7 text-slate-900"
            data-aos={"fade-right"}
          >
            I am currently looking for remote jobs.
        ...
        >
          ...
          <button className="py-1 md:py-2 lg:py-3 mt-3 lg:mt-5 text-white mx-auto px-4  lg:px-9 bg-blue-600 border-2 w-fit border-blue-500 rounded-3xl  hover:-translate-y-1.5 duration-[350ms] hover:duration-[350ms] hover:bg-blue-800 hover:scale-[1.023] focus:bg-blue-800 sm:text-xl  animate-zoomy">
            <a
              href={require("../../assets/files/Amjad-Ali-Resume.pdf")}
              download={"Amjad-Ali-Resume.pdf"}
            >
              Download CV
              <DownloadIcon />
            </a>
