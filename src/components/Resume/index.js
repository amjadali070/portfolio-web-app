...
import { FaCode, FaDesktop, FaCog, FaBrain, FaMobile, FaTools } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          {/* <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"Next JS"} percent={65} />
            <BarGraph name={"Node JS"} percent={70} />
            <BarGraph name={"Epxress JS"} percent={70} />
